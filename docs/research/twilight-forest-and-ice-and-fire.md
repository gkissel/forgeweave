...
| Naga scale | `naga_ward` | `damage_floor` | A coiling guardian's thick scale armor reads as "never take less than a floor amount," the same shape `piercing_guard` gives bone armor |
