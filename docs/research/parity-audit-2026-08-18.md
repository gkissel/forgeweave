...
| Slime islands (shell, lakes, trees, plants) | `SlimeIslandGenerator:51-320` | biomes/structures | `worldgen/SlimeIslandFeature`+`SlimeIslandShape` (#449): shell, grass, trees, plants; no lake, no vines | partial | Y (SCOPE:75, #449) | medium | T18 |
