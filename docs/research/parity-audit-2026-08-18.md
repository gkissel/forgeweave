...
- [ ] **T77 — Doc corrections** — SCOPE M3.5 vanilla-arrow pickup line, SCOPE M3.5 "traits with a launcher branch" claim (PR #410), restore the upstream shortbow description now `preventSlowDown` is ported, book tools-page order (docs, low, M3.5-8).
