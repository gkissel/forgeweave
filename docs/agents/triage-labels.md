...
The engineering skills speak in terms of five canonical triage roles. This file maps those roles to the label strings used in this repository.

| Label in engineering skills | Label in GitHub | Meaning |
| --- | --- | --- |
