...
| EMI (D-M8-2) | A spike table covering all 14 recipe types across the 12 category classes through EMI's JEI-plugin bridge, then a native plugin for exactly the categories the bridge fails. If the bridge carries everything, the plugin is one paragraph saying so. |
