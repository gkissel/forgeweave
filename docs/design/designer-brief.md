...
- **Todo o Modifier Worktable (#1064).** A folha da tela (256x256), o topo do bloco e a lateral do bloco vêm copiados sem alteração da branch 1.20 upstream, cada um com linha no `NOTICE.md`. Nada para desenhar aqui, pelo mesmo motivo das folhas de GUI acima.
